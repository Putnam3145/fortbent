-- made by Kurik Amudnil: http://www.bay12forums.com/smf/index.php?topic=91166.msg4336125#msg4336125 used for a bit of a different purpose
...
if unit then
	...
	for i=0,#v.layer_status - 1,1 do
		for k,vv in ipairs(v.layer_status[i]) do vv = false	end	-- severed, leaking layers (Urist Da Vinci)
